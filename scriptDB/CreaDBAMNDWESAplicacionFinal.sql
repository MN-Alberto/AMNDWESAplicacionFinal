...
CREATE DATABASE IF NOT EXISTS DBAMNDWESAplicacionFinal;
 
USE DBAMNDWESAplicacionFinal;
...
CREATE USER IF NOT EXISTS 'userAMNDWESAplicacionFinal'@'%' IDENTIFIED BY 'paso';
GRANT ALL PRIVILEGES ON DBAMNDWESAplicacionFinal.* TO 'userAMNDWESAplicacionFinal'@'%';
FLUSH PRIVILEGES;